...
import { Home, Search, Library, Heart, Upload, Play, Pause, SkipBack, SkipForward, Shuffle, Repeat2, Volume2, Plus, Smartphone, MoreHorizontal, ChevronDown } from 'lucide-react';
import './style.css';
...
function App(){
 ...
 const go=n=>{setTab(n);if(n!=='Search')setQuery('')};
 return <div className="app">
  <aside><div className="brand"><span className="logo">C</span><b>CHINTU<span>MUSIC</span></b></div>
   ...
   <div className="section"><small>YOUR MUSIC</small><button onClick={()=>setTab('Library')}><Heart size={18}/>Liked Songs</button><label><Upload size={18}/>Import Music<input hidden multiple accept="audio/*" type="file" onChange={importMusic}/></label><button><Plus size={18}/>New Playlist</button></div>
